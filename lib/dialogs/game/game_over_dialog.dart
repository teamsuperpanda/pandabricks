      ...
      child: GlassMorphismCard(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              const Icon(Icons.gamepad_rounded, size: 64, color: Colors.redAccent),
              const SizedBox(height: 16),
              Text(l10n.gameOver, style: const TextStyle(fontSize: 28, color: Colors.white, fontWeight: FontWeight.w700)),
              const SizedBox(height: 16),
              GlassMorphismCard(
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      Text(l10n.finalScore, style: const TextStyle(fontSize: 16, color: Colors.white70, fontWeight: FontWeight.w500)),
              ...
              Row(
                children: [
                  DialogButtonCompact(icon: Icons.refresh, label: l10n.playAgain, onTap: onRestart),
                  const SizedBox(width: 12),
                  DialogButtonCompact(icon: Icons.home, label: l10n.mainMenu, onTap: onMainMenu),
                ],
              ),
            ],
          ),
