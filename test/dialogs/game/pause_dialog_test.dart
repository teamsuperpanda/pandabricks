...
void main() {
  group('PauseDialog', () {
    ...
    testWidgets('displays resume and main menu buttons', (WidgetTester tester) async {
      await tester.pumpWidget(buildPauseDialog());
      expect(find.byIcon(Icons.play_arrow_rounded), findsOneWidget);
      expect(find.byIcon(Icons.home_rounded), findsOneWidget);
    });

    testWidgets('calls onResume when resume tapped', (WidgetTester tester) async {
      var called = false;
    ...
    testWidgets('calls onMainMenu when main menu tapped', (WidgetTester tester) async {
      var called = false;
      await tester.pumpWidget(buildPauseDialog(onMainMenu: () => called = true));
